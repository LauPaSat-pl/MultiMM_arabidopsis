...
class ListOfArgs(list):
    ...
    def parse_args(self):
        ...
        for arg in self.arg_list:
            parser.add_argument(arg['name'], help=arg['help'], type=arg.get('type', str),
                                default=arg.get('default', ''), val=arg.get('val', ''))
...
args = ListOfArgs([
    # Platform settings
    Arg('PLATFORM', help=f"name of the platform. Available choices: {' '.join(available_platforms)}", type=str,
        default='CPU', val='CPU'),
    Arg('CPU_THREADS', help=f"The number of CPU threads (in case you would like to specify them).", type=int,
        default='', val=''),
    ...
    Arg('GENERATE_ENSEMBLE',
        ...
        type=bool, default='False', val='False'),
    Arg('N_ENSEMBLE', help="Number of samples of structures that you would like to calculate.", type=int, default='',
        val=''),
    Arg('DOWNSAMPLING_PROB', help="Probability of downsampling contacts (from 0 to 1).", type=float, default='1.0',
        val='1.0'),
    Arg('FORCEFIELD_PATH', help="Path to XML file with forcefield.", type=str, default=default_xml_path,
        val=default_xml_path),
    Arg('N_BEADS', help="Number of Simulation Beads.", type=int, default='50000', val='50000'),
    Arg('COMPARTMENT_PATH',
        help="It should be a .bed file with subcompartments from Calder (or something in the same format).", type=str,
        default='', val=''),
    ...
    Arg('GENE_TSV', help="A .tsv with genes and their locations in the genome.", type=str, default=default_gene_path,
    ...
    Arg('GENE_WINDOW', help="The window around of the area around the gene of interest.", type=int, default='100000',
        val='100000'),
    Arg('ATACSEQ_PATH', help="A .bw or .BigWig file path with atacseq data. It is not required.", type=str, default='',
        val=''),
    ...
    Arg('POL_HARMONIC_BOND_R0', help="harmonic bond distance equilibrium constant", type=float, default='0.1',
        val='0.1'),
    Arg('POL_HARMONIC_BOND_K', help="harmonic bond force constant (fixed unit: kJ/mol/nm^2)", type=float,
        default='300000.0', val='300000.0'),

    # Basic polymer stiffness
    Arg('POL_USE_HARMONIC_ANGLE', help="Use harmonic angle interaction.", type=bool, default='True', val='True'),
    Arg('POL_HARMONIC_ANGLE_R0', help="harmonic angle distance equilibrium constant", type=float, default=str(pi),
        val=str(pi)),
    Arg('POL_HARMONIC_ANGLE_CONSTANT_K', help="harmonic angle force constant (fixed unit: kJ/mol/radian^2)", type=float,
        default='100.0', val='100.0'),

    # Long-Range loop bonds
    Arg('LE_USE_HARMONIC_BOND', help="Use harmonic bond interaction for long range loops.", type=bool, default='True',
        val='True'),
    Arg('LE_FIXED_DISTANCES',
        help="For fixed distances between loops. False if you want to correlate with the hatmap strength.", type=bool,
        default='False', val='False'),
    Arg('LE_HARMONIC_BOND_R0', help="harmonic bond distance equilibrium constant", type=float, default='0.1',
        val='0.1'),
    Arg('LE_HARMONIC_BOND_K', help="harmonic bond force constant (fixed unit: kJ/mol/nm^2)", type=float,
        default='30000.0', val='30000.0'),
    ...
    Arg('EV_R_SMALL', help="Add something small in denominator to make it not exploding all the time.", type=float,
        default='0.05', val='0.05'),
    ...
    Arg('COB_DISTANCE', help='Block copolymer equilibrium distance for chromosomal blocks.', type=float, default='',
        val=''),
    ...
    Arg('SCB_DISTANCE', help='Block copolymer equilibrium distance for chromosomal blocks.', type=float, default='',
        val=''),
    ...
    Arg('IBL_USE_B_LAMINA_INTERACTION', help='Interactions of B compartment with lamina.', type=bool, default='False',
        val='False'),
    Arg('IBL_SCALE', help='Scaling factor for B comoartment interaction with lamina.', type=float, default='400.0',
        val='400.0'),
    ...
    Arg('POINTS_PER_NUC', help='The number of points that consist a nucleosome helix.', type=int, default='20',
        val='20'),
    ...
    Arg('SIM_ERROR_TOLERANCE', help='Error tolerance for variable MD simulation', type=float, default='0.01',
        val='0.01'),
    ...
    Arg('SIM_SAMPLING_STEP', help='It determines in t how many steps we save a structure.', type=int, default='100',
        val='100'),
    Arg('SIM_INTEGRATOR_TYPE', help='Alternative: langevin, verlet', type=str, default='langevin', val='langevin'),
    Arg('SIM_INTEGRATOR_STEP', help='The step of integrator.', type=Quantity, default='1 femtosecond',
        val='1 femtosecond'),
    Arg('SIM_FRICTION_COEFF', help='Friction coefficient (Used only with langevin integrator)', type=float,
        default='0.5', val='0.5'),
    Arg('SIM_SET_INITIAL_VELOCITIES', help='Sets initial velocities based on Boltzmann distribution', type=bool,
        default='False', val='False'),
